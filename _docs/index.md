...
| planning | `cli-distribution` | [2026-08-05-cli-distribution-debranding](./active/planning/2026-08-05/2026-08-05-cli-distribution-debranding.md) | 브랜딩 탈-Liam + 별도 리포 분리. 인벤토리 10파일. **4(assets.liambx.com 핫링크 제거) 완료.** **차단: 상표 결정(본인)**. §4 귀속 헤더는 보존 |
